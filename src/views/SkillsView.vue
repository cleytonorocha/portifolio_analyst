<template>
  <section class="pt-5">
    <div class="row container-md px-md-5 mx-md-4 mb-5">
      <h2>Skills</h2>
    </div>
    <div>
...
export default {
  ...
  components: {
    ExperienceCard: () => import("@/components/ExperienceCard.vue"),
  },
};
</script>
